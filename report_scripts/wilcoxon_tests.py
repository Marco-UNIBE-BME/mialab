"""
102475-HS2024-0: Medical Image Analysis Lab: wilcoxon_tests.py
...
@brief
    This file documents how we arrived at the statistical results for our report and presentation.
