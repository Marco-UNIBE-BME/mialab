...
class NiftiImageViewer:
    ...
    def display(self):
        ...
        self.im_display1 = self.ax1.imshow(
            self.image_array1[self.current_slice, :, :],
            cmap='viridis',
            origin='lower',
            vmin=0,
            vmax=5
        ...
        self.im_display2 = self.ax2.imshow(
            self.image_array2[self.current_slice, :, :],
            cmap='viridis',
            origin='lower',
            vmin=0,
            vmax=5
    ...
    def on_scroll(self, event):
        ...
        if event.button == 'up':  # Scroll up
            self.current_slice = min(self.current_slice + 1, self.image_array1.shape[0] - 1)
