...
#     """
    ...
    def apply_closing(self, image: sitk.Image) -> sitk.Image:
        ...
        closing_filter.SetKernelRadius(self.closing_radius)
        return closing_filter.Execute(image)
    ...
    def apply_opening(self, image: sitk.Image) -> sitk.Image:
        ...
        opening_filter.SetKernelRadius(self.opening_radius)
        return opening_filter.Execute(image)
